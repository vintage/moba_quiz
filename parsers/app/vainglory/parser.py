...
class SettingsImporter(base.SettingsImporter):
    def get_objects(self):
        return {
            'ios': {
                'ad_banner': 'ca-app-pub-4764697513834958/6893120062',
                'ad_interstitial': 'ca-app-pub-4764697513834958/2183718861',
                'ad_reward': 'ca-app-pub-4764697513834958/7835609667',
                'tracking': 'UA-77793311-2',
                'store': 'itms-apps://itunes.apple.com/app/id1175817991',
                'store_premium': 'com.puppybox.quizvg.premium_version',
            },
            'android': {
                'ad_banner': 'ca-app-pub-4764697513834958/4637657667',
                'ad_interstitial': 'ca-app-pub-4764697513834958/5695588466',
                'ad_reward': 'ca-app-pub-4764697513834958/9172742067',
